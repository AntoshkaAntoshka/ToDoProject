...
from todoapp.views import UsersCustomViewSet, UsersModelViewSet, ProjectModelViewSet, TODOModelViewSet
...
# router = DefaultRouter()
router.register('custom_users', UsersCustomViewSet, basename='custom')
